...
class Open {
    constructor(oyna) {
        this.btn = document.querySelector(oyna.el);
        this.menu =document.querySelector(oyna.menu);
        this.closer =document.querySelector(oyna.closer);

        this.btn.addEventListener("click", ()=>{
            this.menu.style.top = "0";
        });
        this.closer.addEventListener("click", ()=>{
            this.menu.style.top = "-1200px";
        });
    }
}
